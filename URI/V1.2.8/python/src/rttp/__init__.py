"""
rttp -- RTTP reference implementation (RFC-002 sec. 4.1 framing - sec. 10 addressing - sec. 11 mapping)
...
Authority boundary
------------------
* URI **syntax** -- RFC-002 sec. 10.2 ABNF. This package adds no syntax.
