 ...
 *
 * Authority boundary: URI syntax = RFC-002 §10.2; frame layout = §4.1 as
...
/** The ACTION field is 16 bytes; ACTION_LEN is one byte. See RFC-002 §10.2. */
...
/**
 * Parse one `rttp` URI - an implementation written from RFC-002 §10.2 alone,
